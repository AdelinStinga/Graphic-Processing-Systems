...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Stupidus Maximus", NULL, NULL);
	// Error check if the window fails to create
	if (window == NULL)
	{
		std::cout << "Nu face fereastra esti prost" << std::endl;
		glfwTerminate();
		return -1;
	}
...
//		//initialization matrix 
		...
		//different transformations for each matrixes 
		model = glm::rotate(model, glm::radians(rotation), glm::vec3(0.0f, 1.0f, 0.5f));
